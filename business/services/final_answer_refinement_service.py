...
class FinalAnswerRefinementService:
    ...
    def _build_refinement_prompt(
        ...
        parts = [
            "Ти — фінальний етап формування відповіді користувачу.",
            "У тебе є запит користувача, намір, результати вибірки та чернетка відповіді.",
            "Твоє завдання: сформувати цілісну, людяну відповідь, що безпосередньо відповідає на запит.",
            "",
            "## Запит користувача:",
            user_query,
            "",
        ...
        parts.extend([
            ...
            "5. НЕ повторюй структуровані списки з посиланнями — сформулюй людяну відповідь.",
            "",
            "Поверни ТІЛЬКИ текст фінальної відповіді, без додаткових пояснень:",
        ])
